define("arale-validator/0.10.0/index-debug", ["jquery/2.1.1/jquery-debug", "arale-widget/1.2.0/widget-debug", "arale-base/1.2.0/base-debug", "arale-class/1.2.0/class-debug", "arale-events/1.2.0/events-debug"], function(require, exports, module) {
  module.exports = require("arale-validator/0.10.0/src/validator-debug");
});
define("arale-validator/0.10.0/src/validator-debug", ["jquery/2.1.1/jquery-debug", "arale-widget/1.2.0/widget-debug", "arale-base/1.2.0/base-debug", "arale-class/1.2.0/class-debug", "arale-events/1.2.0/events-debug"], function(require, exports, module) {
  var Core = require("arale-validator/0.10.0/src/core-debug"),
...
define("arale-validator/0.10.0/src/core-debug", ["jquery/2.1.1/jquery-debug", "arale-widget/1.2.0/widget-debug", "arale-base/1.2.0/base-debug", "arale-class/1.2.0/class-debug", "arale-events/1.2.0/events-debug"], function(require, exports, module) {
  var $ = require("jquery/2.1.1/jquery-debug"),
    async = require("arale-validator/0.10.0/src/async-debug"),
    Widget = require("arale-widget/1.2.0/widget-debug"),
    utils = require("arale-validator/0.10.0/src/utils-debug"),
    Item = require("arale-validator/0.10.0/src/item-debug");
  var validators = [];
  var setterConfig = {
    value: $.noop,
    setter: function(val) {
  ...
  var Core = Widget.extend({
    ...
    Statics: $.extend({
      helper: utils.helper
    }, require("arale-validator/0.10.0/src/rule-debug"), {
    ...
    destroy: function() {
      ...
      if (self.element.is("form")) {
        try {
          if (self._novalidate_old == undefined) self.element.removeAttr('novalidate');
          else self.element.attr('novalidate', self._novalidate_old);
        } catch (e) {}
...
define("arale-validator/0.10.0/src/async-debug", [], function(require, exports, module) {
  var async = {};
...
define("arale-validator/0.10.0/src/utils-debug", ["jquery/2.1.1/jquery-debug"], function(require, exports, module) {
  var $ = require("jquery/2.1.1/jquery-debug"),
    Rule = require("arale-validator/0.10.0/src/rule-debug");
  var u_count = 0;
  var helpers = {};
...
define("arale-validator/0.10.0/src/rule-debug", ["jquery/2.1.1/jquery-debug"], function(require, exports, module) {
  var $ = require("jquery/2.1.1/jquery-debug"),
    rules = {},
    messages = {};
  ...
  function addRule(name, operator, message) {
    if ($.isPlainObject(name)) {
      $.each(name, function(i, v) {
        if ($.isArray(v)) addRule(i, v[0], v[1]);
        else addRule(i, v);
      });
      return this;
    }
...
define("arale-validator/0.10.0/src/item-debug", ["jquery/2.1.1/jquery-debug", "arale-widget/1.2.0/widget-debug", "arale-base/1.2.0/base-debug", "arale-class/1.2.0/class-debug", "arale-events/1.2.0/events-debug"], function(require, exports, module) {
  var $ = require("jquery/2.1.1/jquery-debug"),
    utils = require("arale-validator/0.10.0/src/utils-debug"),
    Widget = require("arale-widget/1.2.0/widget-debug"),
    async = require("arale-validator/0.10.0/src/async-debug"),
